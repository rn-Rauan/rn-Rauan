...
Desenvolvedor com experiência em **desenvolvimento web e mobile**, **APIs RESTful** e **arquiteturas escaláveis**. Tenho sólida experiência em todas as etapas da engenharia de software: levantamento de requisitos, modelagem, desenvolvimento, testes e documentação.

🔹 Gosto de transformar ideias em produtos funcionais  
🔹 Foco em clean code e boas práticas  
🔹 Experiência com arquiteturas modernas e testes automatizados
